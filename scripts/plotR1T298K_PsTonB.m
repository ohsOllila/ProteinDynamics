...
load ~/Dropbox/PsTonB/Data/residues.dat
%OPs=load('~/Dropbox/PsTonB/Data/OPfromPLATEAU.dat');

figure(2),clf
for ac = 1:1:91
    filename=['~/Dropbox/PsTonB/Data/NHcorrelationFunctions/T298K/scaledrotation/NHrotaCF_' num2str(ac) '.xvg']  
...
hold on
plot(residues,1./R_1)
load  ~/Dropbox/PsTonB/Data/experimentalRELAXATIONdata/T1experimentalDATA.dat
plot(T1experimentalDATA(:,1),T1experimentalDATA(:,2))
xlabel('N number');
ylabel('T_1 / s^{-1}');
title('T_1');
T_1=[residues,1./R_1'];
T1file=fopen('~/Dropbox/PsTonB/Data/T1fromSmulationsTIP4P_T298K.dat','w');
...
load ~/Dropbox/PsTonB/Data/experimentalRELAXATIONdata/T2experimentalDATA.dat
plot(T2experimentalDATA(:,1),T2experimentalDATA(:,2))
xlabel('N number');
ylabel('T_2 / s^{-1}');
title('T_2');
T_2=[residues,1./R_2'];
T2file=fopen('~/Dropbox/PsTonB/Data/T2fromSmulationsTIP4P_T298K.dat','w');
...
hold on
load ~/Dropbox/PsTonB/Data/experimentalRELAXATIONdata/15N-NOEexperimentalDATA.dat
plot(X15N_NOEexperimentalDATA(:,1),X15N_NOEexperimentalDATA(:,2))
NOEfile=fopen('~/Dropbox/PsTonB/Data/NOEfromSmulationsTIP4P_T298K.dat','w');
...
T12file=fopen('~/Dropbox/PsTonB/Data/T1T2ratioSIMULATIONSwithTIP4P_T298K.dat','w');

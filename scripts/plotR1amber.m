...
figure(2),clf
for ac = 1:1:144
    filename=['~/Dropbox/Calmodulin/Data/NHcorrelationFunctions/withAMBER_400-1000ns/unoriented/NHrotaCF_' num2str(ac) '.xvg']  
...
title('T_1');
T_1=[residues,1./R_1'];
T1file=fopen('~/Dropbox/Calmodulin/Data/T1fromSmulationsAMBER.dat','w');
...
title('T_2');
T_2=[residues,1./R_2'];
T2file=fopen('~/Dropbox/Calmodulin/Data/T2fromSmulationsAMBER.dat','w');
...
NOEfile=fopen('~/Dropbox/Calmodulin/Data/NOEfromSmulationsAMBER.dat','w');

...
\section{Methods}
\subsection{Spin relaxation analysis from MD simulations}
...
\begin{table}[htb]
\centering
\caption{Systems simulated in this work.
}\label{ROTdiffCOEFFS}
\begin{tabular}{c c c c c c}
Protein     & Water model & T (K)  &  $t_{\rm sim}$ (ns)   &  $t_{\rm anal}$ (ns)   &  files \\
PaTonB      & tip4p       & 298    & ?                   &  ?                   & \cite{??} \\
PaTonB      & tip4p       &  ?     & 400                 &  390                 & \cite{??} \\
PaTonB      & OPC4        &  ?     & 1200                &                      & \cite{??}  \\
HpTonB-92   & tip3p       &        &            	 &                      & \cite{??} \\
HpTonB-92   & tip4p       &        &            	 &                      & \cite{??} \\
HpTonB-92   & OPC4        &        &            	 &                      & \cite{??} \\
  %\hline
\end{tabular}
\end{table}
...
molecular dynamics simulation are shown in Fig.~\ref{exampleCORRF}.
\begin{figure}[!h]
  ...
  \caption{Example correlation functions from residue 269 of PsTonB simulated with OPC water model.
    ...
    The plateau of this gives the order paramater square $S^2$. \label{exampleCORRF}}%
\end{figure}

The intertia tensor angles as a function of time and mean square angular
deviations are shown in Fig. \ref{RMASDplot}
\begin{figure}[!h]
...
\begin{table}[htb]
\centering
\caption{Rotational diffusion coefficients calculated for PsTonB.
}\label{ROTdiffCOEFFS}
...
\begin{figure}[!p]
%  \includegraphics[width=8.5cm]{/Users/osollila/Dropbox/TonB/Figs/longCONSTRrelDATA.eps}%
  \includegraphics[width=8.5cm]{/home/samuli/Dropbox/TonB/Figs/longCONSTRrelDATA.eps}%
...
%  \includegraphics[width=13cm]{/Users/osollila/Dropbox/TonB/Figs/relaxationDATAplot.eps}%
  \includegraphics[width=13cm]{/home/samuli/Dropbox/TonB/Figs/relaxationDATAplot.eps}%
...
\begin{figure}[!h]
%  \includegraphics[width=13cm]{/Users/osollila/Dropbox/PsTonB/Figs/relaxationDATAplotCOMP.eps}%
  \includegraphics[width=13cm]{/home/samuli/Dropbox/PsTonB/Figs/relaxationDATAplotCOMP.eps}%

...
R_{1}=\frac{d_{\rm{NH}}^2N_{\rm{H}}}{20}\bigg[j(\omega_{\rm{H}}-\omega_{\rm{N}})+3j(\omega_{\rm{N}})+6j(\omega_{\rm{N}}+\omega_{\rm{H}})\bigg] +j(\omega_{\rm{N}})[2\pi \omega_{\rm{N}} 160*10^(-6)]^2/15,
\end{equation}
\begin{equation}\label{R2}
R_{2}=\frac{1}{2}\frac{d_{\rm{NH}}^2N_{\rm{H}}}{20}\bigg[j(\omega_{\rm{H}}-\omega_{\rm{N}})+3j(\omega_{\rm{N}})+6j(\omega_{\rm{N}}+\omega_{\rm{H}})+4j(0)+6j(\omega_{\rm{H}})\bigg]+[4j(0) +3j(\omega_{\rm{N}})][2\pi \omega_{\rm{N}} 160*10^(-6)]^2/(15*6),
\end{equation}
